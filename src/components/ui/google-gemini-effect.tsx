  ...
  return (
    <div className={cn("sticky top-0 h-screen flex items-center justify-center", className)}>
      <div className="relative z-10">
        <p className="text-4xl md:text-7xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-b from-foreground to-muted-foreground pb-4">
          {title || `All-in-One CRM Platform`}
        </p>
        <p className="text-base md:text-xl font-normal text-center text-muted-foreground mt-4 max-w-2xl mx-auto px-4">
          {description ||
            `Scroll this component and see the animation come to life`}
        </p>
      </div>
      <svg
        width="1440"
        ...
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-7xl -z-10"
      >
        <motion.path
